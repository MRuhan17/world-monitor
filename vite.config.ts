...
const VARIANT_META: Record<string, {
  ...
  tech: {
    ...
    url: 'https://tech.world-monitor.app/',
  ...
  finance: {
    ...
    url: 'https://finance.world-monitor.app/',
  ...
  return {
    ...
    transformIndexHtml(html) {
      return html
        ...
        .replace(/"alternateName": "world-monitor"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/world-monitor\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      militaryServerMod, militaryHandlerMod,
        ...
        import('./src/generated/server/world-monitor/seismology/v1/service_server'),
        import('./server/world-monitor/seismology/v1/handler'),
        import('./src/generated/server/world-monitor/wildfire/v1/service_server'),
        import('./server/world-monitor/wildfire/v1/handler'),
        import('./src/generated/server/world-monitor/climate/v1/service_server'),
        import('./server/world-monitor/climate/v1/handler'),
        import('./src/generated/server/world-monitor/prediction/v1/service_server'),
        import('./server/world-monitor/prediction/v1/handler'),
        import('./src/generated/server/world-monitor/displacement/v1/service_server'),
        import('./server/world-monitor/displacement/v1/handler'),
        import('./src/generated/server/world-monitor/aviation/v1/service_server'),
        import('./server/world-monitor/aviation/v1/handler'),
        import('./src/generated/server/world-monitor/research/v1/service_server'),
        import('./server/world-monitor/research/v1/handler'),
        import('./src/generated/server/world-monitor/unrest/v1/service_server'),
        import('./server/world-monitor/unrest/v1/handler'),
        import('./src/generated/server/world-monitor/conflict/v1/service_server'),
        import('./server/world-monitor/conflict/v1/handler'),
        import('./src/generated/server/world-monitor/maritime/v1/service_server'),
        import('./server/world-monitor/maritime/v1/handler'),
        import('./src/generated/server/world-monitor/cyber/v1/service_server'),
        import('./server/world-monitor/cyber/v1/handler'),
        import('./src/generated/server/world-monitor/economic/v1/service_server'),
        import('./server/world-monitor/economic/v1/handler'),
        import('./src/generated/server/world-monitor/infrastructure/v1/service_server'),
        import('./server/world-monitor/infrastructure/v1/handler'),
        import('./src/generated/server/world-monitor/market/v1/service_server'),
        import('./server/world-monitor/market/v1/handler'),
        import('./src/generated/server/world-monitor/news/v1/service_server'),
        import('./server/world-monitor/news/v1/handler'),
        import('./src/generated/server/world-monitor/intelligence/v1/service_server'),
        import('./server/world-monitor/intelligence/v1/handler'),
        import('./src/generated/server/world-monitor/military/v1/service_server'),
        import('./server/world-monitor/military/v1/handler'),
      ]);
