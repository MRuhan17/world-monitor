...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/world-monitor/conflict/v1/handler.ts', 'server/world-monitor/infrastructure/v1/handler.ts', 'server/world-monitor/cyber/v1/handler.ts', 'server/world-monitor/maritime/v1/handler.ts', 'server/world-monitor/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/world-monitor/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/world-monitor/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/world-monitor/military/v1/handler.ts'],
    locality: 'api-key',
