// Tech/AI variant - tech.world-monitor.app
...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: 'CISA Advisories', url: 'https://rss.world-monitor.app/api/rss-proxy?url=' + encodeURIComponent('https://www.cisa.gov/cybersecurity-advisories/all.xml') },
