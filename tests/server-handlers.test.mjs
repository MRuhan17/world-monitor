...
import { deduplicateHeadlines } from '../server/world-monitor/news/v1/dedup.mjs';
...
describe('getHumanitarianSummary handler', () => {
  const src = readSrc('server/world-monitor/conflict/v1/get-humanitarian-summary.ts');
...
describe('humanitarian_summary.proto', () => {
  const proto = readSrc('proto/world-monitor/conflict/v1/humanitarian_summary.proto');
...
describe('getVesselSnapshot caching (HIGH-1)', () => {
  const src = readSrc('server/world-monitor/maritime/v1/get-vessel-snapshot.ts');
